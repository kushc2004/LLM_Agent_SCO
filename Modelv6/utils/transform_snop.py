...
- The symbol in the shape should be the symbol of a parameters only. Do not define shape which is not a symbol of any parameter. 
- sBefore defining every shape check all the parameter symbols and then only define the shape.
